...
func searchReqP(dir string, providerProfileID string, query string, fullResults int) engine.SearchRequest {
	return engine.SearchRequest{Workspace: wsRefP(dir, providerProfileID), Query: query, FullResults: fullResults}
}
